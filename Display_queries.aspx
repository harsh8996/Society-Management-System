<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Display_queries.aspx.cs" Inherits="Display_queries" %>
...
<div class="wrapcontact">
	 <div class="done">
				...
				<div style="margin-left:15%;margin-top:3%;">
					...
					<!-- Code -->
                    <asp:GridView runat="server" ID="gridview" DataKeyNames="Query_Id" OnRowDataBound="OnRowDataBound" OnRowDeleting="OnRowDeleting" EmptyDataText="No records has been added." AutoGenerateDeleteButton="true"></asp:GridView>
				</div>
