...
================================================== -->
    ...
    <div style="overflow-x:auto">
       ...
       <table style="padding:inherit; font-family: hbhhnbbbb; table-layout: auto;">
            <tr>
            <th colspan="2"><h2>Payment</h2></th>
                </tr>
            <tr>
        <td class="auto-style1">
            <asp:Label ID="Labels" runat="server" Text="Flat number:"></asp:Label>
        </td>
         <td>
        <b><asp:Label id="txt_flat_no" runat="server" ></asp:Label></b>
         </td>
         </tr>
        <tr>
            <td class="auto-style1">
        <asp:Label ID="label" runat="server" Text="No of Months:"></asp:Label>
            </td>
            <td>
<asp:DropDownList ID="DropDownList2" runat="server" style="border: 2px solid #7d6754; border-radius: 5px; padding: 3px; -webkit-appearance: none; background-image: url('http://localhost:57735/images/menu-icon.png'); background-position: 50px; background-repeat: no-repeat; text-indent: 0.01px; text-overflow: ''; width: 75px;" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" AutoPostBack="True">             
            ...
            <tr>
                <td class="auto-style1">
        <asp:Label ID="Label3" runat="server" Text="Amount to pay: "></asp:Label>
                    </td>
                <td>
        <asp:Label ID="total" runat="server"></asp:Label>
            ...
            <tr>
                <td class="auto-style1">
        <asp:Label ID="Label4" runat="server" Text="mode of payment: "></asp:Label>
                    </td>
                <td>
