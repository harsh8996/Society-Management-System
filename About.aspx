		...
		<div class="twelve columns">
			...
			<div class="infotext">
                ...
                <a style="float:right" href="Add_News.aspx" runat="server" id="news">Add News</a>
                 <asp:DropDownList ID="dropdown" AutoPostBack="true" runat="server" style="border: 2px solid #7d6754; border-radius: 5px; padding: 3px; -webkit-appearance: none; background-image: url('http://localhost:57735/images/menu-icon.png'); background-position: 125px; background-repeat: no-repeat; text-indent: 0.01px; text-overflow: ''; ; width: 150px; float: right;" OnSelectedIndexChanged="dropdown_SelectedIndexChanged" >
...
<div class="row">
	...
	<div class="eight columns">
		...
		<p>
			 Swaminarayan park is situated at vasna gam one of the area of ahmedabad. It was created by (buildername). There are two Blocks with 12 floors. Best place to live in ahmedabad. Swaminarayan park has malls,schools and other places nearby it. So why need to go anywhere? It has all people want.
		</p>
		<p>
			 We here provide the best services to our customers.Our goal is make satisfication to our customers.Hence,Swaminarayan park make best place to live for people.
		</p>
		<p>
			All issues concerning in  society are examined by society manager and secretary of society. 
		</p>
		<p>
			 We provide following facilities to our society to make it best environment to live for people.
			 <ul>
			 <li>3BHK Flats</li>
			 <li>Parking</li>
			 <li>Garden</li>
			 <li>Play ground for childen</li>
			 <li>Gyms</li>
			 <li>Theatre</li>
			 <li>Swimming pool</li>
		...
		<div class="panel">
			<p>
				<b>“The modern human has mastered the art of building toxic homes and cities.” </b>
			</p>
			<!-- <p class="text-right">
				<i>Steven Magee</i>
			</p> -->
		...
		<dl class="tabs">
			...
			<dd><a href="#simple3">feedback</a></dd>
			<dd><a href="#simple4">Prices and budget</a></dd>
		</dl>
		<ul class="tabs-content">
			<li class="active" id="simple1Tab">
			<p>
				 We have best services to provide our customers. clients are god to us. we provide best place to live in ahmedabad.
			</p>
			<p>
				 we have nearby best schools for children to study.
			</p>
			<p>
				we have nearby best malls of ahmedabad for shoppings. And Much more in society.
			</p>
			</li>
			<li id="simple2Tab">
			<p>We work as our customer's requirements.we make better environment to live in society. Maintance and other important things in society is maintained in proper way. </p>
			<p> every week there is society meeting held by secretary to society issues and interaction between society members.
			</li>
			<li id="simple3Tab">
			<p>Customers feedback is mean to us.every feedback to our society is important to us. it make us to improve our society make it better place to live.<p>
			<p>visitors of society also can give feedback us to improve our society.
			</li>
			<li id="simple4Tab">
			<p>Prices of the flats and rent prices are relavant to normal people. Common people can affords to budgets in our society.</p>
			<p>we also provide house on rent for bachelors, students and other people.</p>
			</li>
		</ul>
	...
	<div class="four columns">
		<div class="teamwrap teambox">
			<asp:Image ImageUrl="images\vatsal.jpeg" runat="server" AlternateText="" />
			<div class="mask">
				<h2>Vatsal Soni</h2>
				<p>
					One of our coder, working for this company since the beginning.</p>
			...
			<div class="teamwrap teambox">
                <asp:Image runat="server" AlternateText="" ImageUrl="images\harsh2.jpg" />
				<div class="mask">
					<h2>Harsh Shah</h2>
					<p>
						One of our coder and designer ,working for this company since the beginning.</p>
						<div class="social socialteam facebook">
							<a href="#"></a>
						</div>
						<div class="social socialteam twitter">
			...
			<div class="teamwrap teambox">
                <asp:Image runat="server" AlternateText="" ImageUrl="images\shyam.jpeg" />
					<div class="mask">
						<h2>Sherashiya Shyam</h2>
						<p>
							One of our web designer, working for this company since the beginning.</p>
							<div class="social socialteam facebook">
								<a href="#"></a>
							</div>
							<div class="social socialteam twitter">
